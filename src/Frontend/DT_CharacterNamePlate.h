...
#ifndef	__DT_CharacterNamePlate_h__
#define	__DT_CharacterNamePlate_h__
...
/* TestPoint FuncList ------------------------------------------------------*/
#define		__DtFunc_CharacterNamePlate		0
#define		__DtFunc_initialize		2
#define		__DtFunc_setVisible		3
#define		__DtFunc_startShow		4
#define		__DtFunc_update		5
#define		__DtFunc__setPosition		6
...
#define	__Dt__DtFunc_CharacterNamePlate__DtStep_0	/*FuncIn*/	
#define	__Dt__DtFunc_CharacterNamePlate__DtStep_1	/*FuncIn*/	
...
#define	__Dt__DtFunc_initialize__DtStep_3	/*if*/	
#define	__Dt__DtFunc_initialize__DtStep_4	/*if*/	
#define	__Dt__DtFunc_initialize__DtStep_5	/*FuncOut*/	
#define	__Dt__DtFunc_setVisible__DtStep_0	/*FuncIn*/	
#define	__Dt__DtFunc_setVisible__DtStep_1	/*FuncOut*/	
#define	__Dt__DtFunc_startShow__DtStep_0	/*FuncIn*/	
#define	__Dt__DtFunc_startShow__DtStep_1	/*if*/	
#define	__Dt__DtFunc_startShow__DtStep_2	/*FuncOut*/	
