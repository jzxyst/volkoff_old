...
/*! @par include */
#include "stdafx.h"
#include	"DT_ValfirleToken.h"	/* For DynamicTracer-TestPoint */
...
ValfirleToken::ValfirleToken()
    : mWeaponLevel  ( 1 )
{
	__DtTestPoint( __DtFunc_ValfirleToken, __DtStep_0 )
	...
	__DtTestPoint( __DtFunc_ValfirleToken, __DtStep_1 )
}
...
ValfirleToken::~ValfirleToken()
{
	__DtTestPoint( __DtFunc_ValfirleToken, __DtStep_2 )
	this->Release();
	__DtTestPoint( __DtFunc_ValfirleToken, __DtStep_3 )
}
