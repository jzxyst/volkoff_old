...
/*! @par include */
#include "stdafx.h"
#include	"DT_MidBoss2.h"	/* For DynamicTracer-TestPoint */
#include "MidBoss2.h"
#include "Player.h"
...
MidBoss2::MidBoss2()
    : mWeaponLevel  ( 1 )
{
	__DtTestPoint( __DtFunc_MidBoss2, __DtStep_0 )
	...
	__DtTestPoint( __DtFunc_MidBoss2, __DtStep_1 )
}
...
MidBoss2::~MidBoss2()
{
	__DtTestPoint( __DtFunc_MidBoss2, __DtStep_2 )
	this->Release();
	__DtTestPoint( __DtFunc_MidBoss2, __DtStep_3 )
}
...
bool MidBoss2::Initialize( const CreateData& data_ )
{
	...
	__DtTestPoint( __DtFunc_Initialize, __DtStep_7 )
	return r;
}
